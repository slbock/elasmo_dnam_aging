...
load("/dir/work/ZEBRA_SHARK/R/filteredByCov_ouput/zebrashark.5x.meth.destr.53S.RData")
...
save(zebrashark.5x.percmeth.53S.impute, file="/dir/work/ZEBRA_SHARK/R/filteredByCov_ouput/zebrashark.5x.percmeth.53S.impute.RData")
