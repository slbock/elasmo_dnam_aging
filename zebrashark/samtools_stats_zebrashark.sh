...
#SBATCH --output=/dir/scripts/GN22895-GN22928_samtools_zebrashark_1.0.o
#SBATCH --error=/dir/scripts/GN22895-GN22928_samtools_zebrashark_1.0.e
...
do
  samtools sort /dir/work/ZEBRA_SHARK/Bismark/sSteTig4_Genome/${i}.multiple.deduplicated.bam -o /dir/work/ZEBRA_SHARK/Bismark/sSteTig4_Genome/Sorted_Bam/${i}_sort.bam
done
