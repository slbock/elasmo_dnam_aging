...
#SBATCH --output=/scratch/sb61937/scripts/fastqc_zebrashark_5.0.o
#SBATCH --error=/scratch/sb61937/scripts/fastqc_zebrashark_5.0.e
...
do
  fastqc -t 8 ${i}_*_L00*_R1_001.fastq.gz -o /scratch/sb61937/work/ZEBRA_SHARK/Pretrim_fastqc/METHYLSEQ_121923
  fastqc -t 8 ${i}_*_L00*_R2_001.fastq.gz -o /scratch/sb61937/work/ZEBRA_SHARK/Pretrim_fastqc/METHYLSEQ_121923
done


cd /scratch/sb61937/work/ZEBRA_SHARK/Pretrim_fastqc/METHYLSEQ_121923
multiqc -d *_fastqc.zip -o /scratch/sb61937/work/ZEBRA_SHARK/Pretrim_fastqc/METHYLSEQ_121923
